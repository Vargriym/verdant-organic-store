        ...
        <div className="login_Form bg-green-50 px-8 py-6 border border-green-100 rounded-xl shadow-md">
          ...
          <div className="mb-3">
            <input
              ...
              className="bg-green-50 border text-green-300 border-green-200 px-2 py-2 w-96 rounded-md outline-none placeholder-black"
            />
          </div>
          ...
          <div className="mb-3">
            <textarea
              ...
              rows="5"
              className=" w-full px-2 py-1 text-green-300 bg-green-50 border border-green-200 rounded-md outline-none placeholder-black "
            ></textarea>
          </div>
