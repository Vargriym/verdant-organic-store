                    ...
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <tr key={index} className="text-green-300">
                          ...
                          <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-green-600  first:border-l-0 border-green-100 stroke-black text-slate-500 first-letter:uppercase ">
                            {order.status}
                          </td>
