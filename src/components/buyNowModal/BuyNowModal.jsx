        ...
        <DialogBody className="">
          <div className="mb-3">
            <input
              ...
              className="bg-green-50 border border-green-200 px-2 py-2 w-full rounded-md outline-none text-green-600 placeholder-black"
            />
          </div>
          <div className="mb-3">
            <input
          ...
          <div className="mb-3">
            <input
              ...
              className="bg-green-50 border border-green-200 px-2 py-2 w-full rounded-md outline-none text-green-600 text-green-600 placeholder-black"
            />
          </div>
