                      ...
                      <div className="flex justify-center px-20 mb-12 md:px-0">
                        {cartItems.some((p) => p.id === item.id) ? (
                          <button
                            ...
                            className="px-8 py-3 text-sm text-center font-medium md:px-6 lg:px-7 md:py-[0.9rem] lg:font-semibold text-white bg-gray-800 border border--600 duration-300  hover:bg-gray-900 hover:text-gray-100 rounded-full"
                          >
                            Remove from Cart
                          </button>
                        ) : (
